...
<style>
    ...
    .scam-slueth-partners .container {
        display: flex;
        padding-left: 10%;
        padding-right: 10%;
        gap: 50px;
    ...
    .scam-slueth-partners .container .an-image-container {
        display: flex;
        align-items: center;
        justify-content: center;
    }
...
<div class="utf_main_banner_area" style="background-image:url('<?php the_field('top_banner_background_image'); ?>');" data-overlay="8">
    <div class="max-w-1140px mx-auto px-[15px] xl:px-0">
        <div class="w-full md:w-8/12 relative">
            ...
            <form id="domainsearchprocess" action="" method="post">
...
<div class="max-w-1140px mx-auto ">
	...
	Content-Type: application/json*/
		  ...
		  "threatEntries": [
			{"url": "' . $url . '"},
                ...
                if (isset($_POST['keywords']) && trim($_POST['keywords']) != '') {
                    ...
                    $is_domain_white_listed = false;
                    while ($whitelistqueryVal = mysqli_fetch_assoc($whitelistquery)) {
                        $whitelist_data[] = $whitelistqueryVal;
                    ...
                    if (isset($_GET['dv_test_7'])) {
                        var_dump($is_domain_white_listed);
                        var_dump($whitelist_data);
                        var_dump($whitelistquery);
                    }
        ...
        <?php
                } else if ($warning_sh != '' && $is_domain_white_listed !== true) {
        ?>
...
<div class="scam-slueth-partners">
    <h2 class="text-4xl text-gold font-roboto font-semibold uppercase text-center mb-8">As <span class="text-black">Featured In</span></h2>

    <div class="container">
        <div class="an-image-container">
            <a href="https://www.theguardian.com/media/2023/feb/06/from-hi-mum-to-crypto-the-latest-scams-to-watch-out-for">
                <img src="https://www.cybertrace.com.au/wp-content/uploads/2023/02/guardian-logo-square-300x300.jpg" width="100px" />
            </a>
        </div>
        <div class="an-image-container">
            <a href="https://australiancybersecuritymagazine.com.au/cybertrace-launches-scamsleuth/">
                <img src="https://www.cybertrace.com.au/wp-content/uploads/2023/02/AustralianCyberSecurityMagazine.png" width="200px" />
            </a>
        </div>
        <div class="an-image-container">
            <a href="https://www.youtube.com/watch?v=boCX3xOgK2o">
                <img src="https://www.cybertrace.com.au/wp-content/uploads/2023/02/image-removebg-preview.webp" width="130px" />
            </a>
        </div>
        <div class="an-image-container">
            <a href="https://www.youtube.com/watch?v=6hc2BrO7Se8">
                <img src="https://www.cybertrace.com.au/wp-content/uploads/2023/02/New-Breakout-03.png" width="180px" />
            </a>
        </div>
    </div>
</div>
<?php
if (isset($_GET['dv_test_2'])) {
?>
